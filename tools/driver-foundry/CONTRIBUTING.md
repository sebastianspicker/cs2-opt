...
Driver Foundry is an independent Rust workspace under `tools/driver-foundry`. Keep product changes within `crates/` and versioned inputs under `data/`.

## Build checks

From `tools/driver-foundry`:
