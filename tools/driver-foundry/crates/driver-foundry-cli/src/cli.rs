...
Driver Foundry provides native Windows GPU driver cleanup and installation planning.
...
pub(crate) enum Commands {
    ...
    Clean(Box<CleanArgs>),
    /// Acquire, filter, apply selected tweaks, and install
...
pub(crate) struct CleanArgs {
    ...
    /// Plan only by default; no host mutation
