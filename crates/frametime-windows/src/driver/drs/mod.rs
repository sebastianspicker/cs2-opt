...
pub(crate) const GLOBAL_PROFILE_NAME: &str = "_GLOBAL_DRIVER_PROFILE";
pub(crate) const CS2_APPLICATIONS: [&str; 2] = ["cs2.exe", "csgos2.exe"];
mod policy;
pub use policy::*;
...
pub(crate) fn with_session<A: NvapiDrs, T>(
    api: &mut A,
...
pub(crate) fn find_existing_profile<A: NvapiDrs>(
    api: &mut A,
    session: &A::Session,
...
pub(crate) fn capture_application_originals<A: NvapiDrs>(
    api: &mut A,
    session: &A::Session,
...
pub(crate) fn ensure_missing_applications<A: NvapiDrs>(
    api: &mut A,
    session: &A::Session,
    profile: &A::Profile,
...
pub(crate) fn validate_backup(backup: &DrsBackup) -> Result<(), DrsError> {
...
pub(crate) fn validate_current_originals<A: NvapiDrs>(
    api: &mut A,
    session: &A::Session,
    backup: &DrsBackup,
) -> Result<(), DrsError> {
...
pub(crate) fn capture_originals<A: NvapiDrs>(
    api: &mut A,
    session: &A::Session,
    profile: &A::Profile,
...
pub(crate) fn verify_settings<A: NvapiDrs>(
    api: &mut A,
    session: &A::Session,
    profile: &A::Profile,
