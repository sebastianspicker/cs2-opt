#[cfg(windows)]
use crate::driver::prepare_cs2_profile;
use crate::*;
pub(crate) fn inspect_nvidia_drs_preparation() -> Result<Inspection, String> {
    #[cfg(windows)]
    {
...
pub(crate) fn capture_nvidia_drs_preparation_receipt() -> Result<ObservationReceipt, String> {
    #[cfg(windows)]
    {
