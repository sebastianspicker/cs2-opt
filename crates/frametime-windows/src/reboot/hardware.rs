...
pub fn inspect_reboot_handoff_state() -> Result<RebootHandoffState, String> {
    inspect_reboot_handoff_state_at(TrustedWorkDir::acquire_fixed()?.path())
}

pub(crate) fn inspect_reboot_handoff_state_at(
    work_dir: &Path,
) -> Result<RebootHandoffState, String> {
...
pub(crate) fn read_reboot_initiator_sid(trusted: &TrustedWorkDir) -> Option<String> {
...
pub(crate) fn same_user_handoff_evidence(
...
pub(crate) fn valid_canonical_sid(value: &str) -> bool {
...
pub(crate) fn safeboot_evidence() -> SafebootEvidence {
...
pub(crate) fn safeboot_evidence_from_bcd(text: &str) -> SafebootEvidence {
...
pub(crate) fn run_value_evidence(
    hive: Hive,
    key: &'static str,
    name: &'static str,
) -> HandoffEvidence {
