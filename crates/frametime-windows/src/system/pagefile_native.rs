...
mod native_pagefile_store {
    ...
    pub(crate) fn close_token(token: HANDLE) {
...
#[cfg(windows)]
pub(crate) fn native_pagefile_inventory() -> Result<PagefileInventory, String> {
...
#[cfg(windows)]
pub(crate) fn native_pagefile_begin(
...
#[cfg(windows)]
pub(crate) fn native_pagefile_verify(
    binding: &PagefileBinding,
    created: Option<&CreatedPagefileToken>,
) -> Result<(), String> {
...
#[cfg(windows)]
pub(crate) fn native_pagefile_compensate(
    binding: &PagefileBinding,
    created: Option<&CreatedPagefileToken>,
) -> Result<(), String> {
...
#[cfg(windows)]
pub(crate) fn native_pagefile_restore(entry: &BackupEntry) -> Result<(), String> {
    native_pagefile_store::restore(entry)
}
#[cfg(not(windows))]
pub(crate) fn native_pagefile_restore(_: &BackupEntry) -> Result<(), String> {
