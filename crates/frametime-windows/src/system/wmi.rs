...
pub(crate) mod native {
    ...
    use windows::{
        Win32::{
            ...
            System::{
                ...
                Variant::{
                    VARIANT, VARIANT_0, VARIANT_0_0, VARIANT_0_0_0, VT_BOOL, VT_BSTR, VT_I1, VT_I2,
                    VT_I4, VT_NULL, VT_UI1,
                },
                Wmi::{
    ...
    pub(crate) fn services() -> Result<IWbemServices, String> {
    ...
    pub(crate) fn set_services_proxy_blanket(services: &IWbemServices) -> Result<(), String> {
        unsafe {
            CoSetProxyBlanket(
                services,
                RPC_C_AUTHN_WINNT,
    ...
    pub(crate) fn set_enumerator_proxy_blanket(
    ...
    pub(crate) fn property_name(name: &str) -> Vec<u16> {
    ...
    pub(crate) fn uint64(object: &IWbemClassObject, name: &str) -> Result<u64, String> {
