...
#[cfg(windows)]
pub(crate) struct DeviceInfoSet(HDEVINFO);
...
#[cfg(windows)]
pub(crate) fn expected_setupapi_error(error: &Error, expected: u32) -> bool {
    error.code() == HRESULT::from_win32(expected)
}

#[cfg(windows)]
pub(crate) fn property_bytes(
    set: HDEVINFO,
...
#[cfg(windows)]
pub(crate) fn wide_values(bytes: &[u8], list: bool) -> Result<Vec<String>, String> {
...
#[cfg(windows)]
pub(crate) fn string_list_property(
    set: HDEVINFO,
    data: &SP_DEVINFO_DATA,
    key: &DEVPROPKEY,
...
#[cfg(windows)]
pub(crate) fn filetime_property(set: HDEVINFO, data: &SP_DEVINFO_DATA) -> Result<u64, String> {
...
#[cfg(windows)]
pub(crate) fn instance_id(set: HDEVINFO, data: &SP_DEVINFO_DATA) -> Result<String, String> {
    let mut required = 0;
...
#[cfg(windows)]
pub(crate) fn raw_chipset_driver_record(
    set: HDEVINFO,
    data: &SP_DEVINFO_DATA,
