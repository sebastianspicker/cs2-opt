...
pub(crate) struct ChipsetDriverRecord {
    pub(crate) instance_id: String,
    pub(crate) hardware_ids: Vec<String>,
    pub(crate) compatible_ids: Vec<String>,
    pub(crate) inf_path: String,
    pub(crate) provider: String,
    pub(crate) driver_version: String,
    pub(crate) driver_date_filetime: u64,
}
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub(crate) struct ChipsetInventory {
    pub(crate) vendor: ChipsetVendor,
    pub(crate) records: Vec<ChipsetDriverRecord>,
}

#[derive(Debug, Clone, PartialEq, Eq)]
pub(crate) struct RawChipsetDriverRecord {
    pub(crate) instance_id: String,
    pub(crate) hardware_ids: Vec<String>,
    pub(crate) compatible_ids: Vec<String>,
    pub(crate) inf_path: String,
...
pub(crate) fn chipset_inventory_from_raw(
...
pub(crate) fn chipset_vendor_bindings(
    hardware_ids: &[String],
...
pub(crate) fn chipset_vendor_from_pci_id(id: &str) -> Result<Option<ChipsetVendor>, String> {
...
pub(crate) fn validate_chipset_record(
    vendor: ChipsetVendor,
...
pub(crate) fn checked_device_text(value: &str, label: &str) -> Result<String, String> {
    if value.is_empty()
        || value.trim() != value
        || value.len() > 4096
        || value
...
pub(crate) fn valid_vendor_package_inf(value: &str) -> bool {
...
pub(crate) fn provider_matches_vendor(vendor: ChipsetVendor, provider: &str) -> bool {
...
pub(crate) fn valid_driver_version(value: &str) -> bool {
    value.len() <= 32
        && value.split('.').count() == 4
...
pub(crate) fn detected_chipset_vendor() -> Result<ChipsetVendor, String> {
...
pub(crate) fn capture_chipset_inventory() -> Result<Option<ChipsetInventory>, String> {
    let vendor = detected_chipset_vendor()?;
    chipset_inventory_from_raw(vendor, enumerate_chipset_driver_records()?)
}

pub(crate) fn verify_chipset_inventory(captured: &Option<ChipsetInventory>) -> Result<(), String> {
...
pub(crate) fn chipset_inventory_matches(
...
#[cfg(not(windows))]
pub(crate) fn enumerate_chipset_driver_records() -> Result<Vec<RawChipsetDriverRecord>, String> {
