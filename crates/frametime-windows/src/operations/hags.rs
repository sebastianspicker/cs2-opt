...
pub(crate) const HAGS_KEY: &str = "SYSTEM\\CurrentControlSet\\Control\\GraphicsDrivers";
pub(crate) const HAGS_NAME: &str = "HwSchMode";
pub(crate) const HAGS_TARGET: u32 = 2;
#[cfg(any(test, windows))]
pub(crate) const HAGS_MIN_BUILD: u32 = 26_100;

pub(crate) fn restore_hags_entry(
    step: &str,
    original: Option<u32>,
    target: u32,
    adapter_ids: &[String],
...
pub(crate) fn hags_pending_verification_items(
...
pub(crate) fn require_hags_effective_before_final_checklist(
    trusted: &TrustedWorkDir,
) -> Result<(), String> {
...
pub(crate) fn read_hags_value() -> Result<Option<u32>, String> {
...
pub(crate) fn write_hags_value(value: u32) -> Result<(), String> {
...
pub(crate) fn hags_change(value: u32) -> RegistryChange {
    RegistryChange {
...
pub(crate) struct HagsAdapterState {
...
#[cfg(not(windows))]
pub(crate) fn compatible_adapter_states() -> Result<Vec<HagsAdapterState>, String> {
...
mod native {
    ...
    #[derive(Clone, Copy)]
    pub(crate) struct NumericAdapter {
        luid: LUID,
        vendor: u16,
        device: u16,
        subsystem: u32,
    ...
    pub(super) fn inspect() -> Result<Vec<HagsAdapterState>, String> {
        ...
        if crate::system::platform::build_number()? < super::HAGS_MIN_BUILD {
            return Err(
    ...
    pub(crate) fn dxgi_adapters() -> Result<Vec<NumericAdapter>, String> {
    ...
    pub(crate) fn system32_gdi32_path() -> Result<PathBuf, String> {
    ...
    pub(crate) fn loaded_path(module: HMODULE) -> Result<PathBuf, String> {
        let mut buffer = vec![0_u16; 32_768];
...
mod hags_tests {
    use super::*;
    #[test]
    pub(crate) fn hags_registry_contract_is_fixed() {
