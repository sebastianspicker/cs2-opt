...
#[derive(Debug)]
pub(crate) struct PublicationRetention {
    _handles: Vec<RetainedHandle>,
}

pub(super) fn publish(package: &AuthenticatedPackage) -> Result<VerifiedPublishedRuntime, String> {
...
fn serialize_manifest(
    manifest: &frametime_domain::runtime::RuntimeManifest,
