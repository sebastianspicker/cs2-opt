...
pub(crate) fn normalized_is_within_work_dir(path: &str) -> bool {
...
mod tests {
    ...
    #[test]
    pub(crate) fn accepts_an_absolute_local_file_path() {
    ...
    #[test]
    pub(crate) fn rejects_devices_network_paths_ads_and_traversal() {
        for path in [
    ...
    #[test]
    pub(crate) fn rejects_the_trusted_work_directory_and_its_descendants() {
        for path in [
    ...
    #[test]
    pub(crate) fn recognizes_hresult_wrapped_missing_file_and_directory_errors() {
