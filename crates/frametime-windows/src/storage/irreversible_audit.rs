...
impl LiveBackend<'_> {
    pub(crate) fn capture_irreversible_audit(
        &mut self,
        operation: Operation,
    ...
    pub(crate) fn persist_irreversible_audit(
        &self,
    ...
    pub(crate) fn replace_irreversible_audit(
        &self,
        audit: &IrreversibleAudit,
        failed: bool,
    ) -> Result<(), String> {
...
pub(crate) fn irreversible_target(step: &str) -> Result<ManualRecoveryTarget, String> {
    match step {
...
pub(crate) fn pending_audit_identity(
    audit: &IrreversibleAudit,
...
pub(crate) fn audit_update_identity(
    audit: &IrreversibleAudit,
) -> (&str, &str, &ManualRecoveryAuditOutcome) {
    match audit {
...
pub(crate) fn audit_entry(audit: IrreversibleAudit) -> CoreAuditEntry {
    match audit {
...
pub(crate) fn entry_irreversible_audit(entry: &CoreAuditEntry) -> Option<IrreversibleAudit> {
    match entry {
...
pub(crate) fn pending_entry_identity(entry: &CoreAuditEntry) -> Option<(&str, &str)> {
    match entry {
