...
$SCRIPT:StepCatalog = @(
    ...
    [PSCustomObject]@{ Phase=1; Step=5;  Category="GPU";      Title="NVIDIA Driver Version";        Tier=2; Risk="SAFE";       Depth="CHECK";      EstKey="";                         CheckOnly=$true;  Reboot=$false }
    ...
    [PSCustomObject]@{ Phase=1; Step=13; Category="System";   Title="Gaming Debloat";               Tier=1; Risk="MODERATE";   Depth="APP";        EstKey="Debloat";                   CheckOnly=$false; Reboot=$false }
    [PSCustomObject]@{ Phase=1; Step=14; Category="System";   Title="Autostart Cleanup";            Tier=1; Risk="SAFE";       Depth="REGISTRY";   EstKey="";                         CheckOnly=$false; Reboot=$false }
    [PSCustomObject]@{ Phase=1; Step=15; Category="System";   Title="Windows Update Blocker";       Tier=2; Risk="MODERATE";   Depth="SERVICE";    EstKey="";                         CheckOnly=$false; Reboot=$false }
    ...
    [PSCustomObject]@{ Phase=1; Step=27; Category="System";   Title="MMCSS + Gaming Priority";      Tier=2; Risk="MODERATE";   Depth="REGISTRY";   EstKey="Win32PrioritySeparation";   CheckOnly=$false; Reboot=$false }
    ...
    [PSCustomObject]@{ Phase=3; Step=11; Category="System";   Title="VRAM Leak Awareness";           Tier=1; Risk="SAFE";       Depth="CHECK";      EstKey="";                         CheckOnly=$true;  Reboot=$false }
