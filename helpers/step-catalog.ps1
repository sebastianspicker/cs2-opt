...
$SCRIPT:StepCatalog = @(
    ...
    [PSCustomObject]@{ Phase=1; Step=15; Category="System";   Title="Windows Update Blocker";       Tier=2; Risk="CRITICAL";   Depth="SERVICE";    EstKey="";                         CheckOnly=$false; Reboot=$false }
    ...
    [PSCustomObject]@{ Phase=3; Step=3;  Category="Network";  Title="NIC Interrupt Affinity";       Tier=3; Risk="MODERATE";   Depth="DRIVER";     EstKey="NIC Tweaks";                CheckOnly=$false; Reboot=$true  }
